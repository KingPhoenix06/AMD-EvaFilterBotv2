        ...
        btn = [
            [
                InlineKeyboardButton(
                    text=f"[{get_size(file.file_size)}]-{🗂️file.file_name}", callback_data=f'files#{file.file_id}'
                ),
            ]
            for file in files
        ]
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔍 Group', url='https://t.me/AMD_Discussion'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"**🎬 Ꮇᴏᴠɪᴇ Νᴀᴍᴇ ** : <code>{search}</code> \n\n**♻️ Ꭻᴏɪɴ ♻️ : @AMD_LinkZz**"
